...
def dataRead():
    ...
    mov(y, osr)             [2] .side(0)  #20: keep number of words to read, QCLK=0, QDIR=1 already - here as earliest as possible
    set(pindirs, 0x0)       [2] .side(2)  #21: change direction, QCLK=1, QDIR=1
    nop()                   [2] .side(0)  #22: QCLK=0, QDIR=1
    nop()                   [0] .side(2)  #23: two turnaround clocks generated
    label("ALL_READ_LOOP")
    ...
    #push(noblock)                         #  : we use autopush to save nmumber of instructions
...
#glitches on DIR signal and on QCLK if 1 MHz - below 2 MHz FAILS!
